...
@CrossOrigin(origins = "https://crm-admin-website.vercel.app")
public class PunchActivityController {
    ...
    public ResponseEntity<?> savePunchActivity(
        ...
        try {
            ...
            CrmPunchActivity savedPunchActivity = punchActivityService.savePunchActivity(punchInImage, punchOutImage, workReport, mobileNumber);
